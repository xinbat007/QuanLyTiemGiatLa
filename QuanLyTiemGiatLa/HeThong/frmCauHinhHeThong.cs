	...
	public partial class frmCauHinhHeThong : Form
	{
		...
		private void frmCauHinhHeThong_Load(object sender, System.EventArgs e)
		{
			try
			{
				...
				cboKhoMayIn.SelectedIndex = Xuly.ThaoTacIniCauHinhPhanMem.ReadKhoMayIn();
                ...
                this.DoiMauButton();
                btnBackUp.Enabled = BienChung.userCurrent.ChucVu == Entity.ChucVu.Admin;
			}
