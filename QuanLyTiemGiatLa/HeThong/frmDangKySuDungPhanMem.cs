        ...
        private void btnChapNhan_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (songaysd == -1)
                {
                    ...
                    DangKySuDungPhanMem.GhiThoiHanSuDung(BienChung.checkKey.IDCPU, 1, BienChung.DaMuaFull, BienChung.checkKey.SoLanDaUpdate);
                ...
                else
                {
                    ...
                    DangKySuDungPhanMem.GhiThoiHanSuDung(BienChung.checkKey.IDCPU, songaysd, BienChung.DaMuaFull, BienChung.checkKey.SoLanDaUpdate);
