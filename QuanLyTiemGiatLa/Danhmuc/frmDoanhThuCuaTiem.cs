...
namespace QuanLyTiemGiatLa.Danhmuc
{
	public partial class frmDoanhThuCuaTiem : Form
	{
        ...
        private void printDoc_PrintDoanhThu(object sender, PrintPageEventArgs e)
        {
            ...
            {	// In khổ nhỏ
				if (MessageBox.Show("Chương trình chưa hỗ trợ, bạn có muốn in khổ to không", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
					InKhoTo(e, dsthunhap);
				//InKhoNho(e, dsthunhap);
            }
            else
            {	// In khổ to
				InKhoTo(e, dsthunhap);
		...
		private void InKhoNho(PrintPageEventArgs e, ListThuNhapTrongNgayEntity dsthunhap)
        {
			MessageBox.Show("Chưa làm", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        }
