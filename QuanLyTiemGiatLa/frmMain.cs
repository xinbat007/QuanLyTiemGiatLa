...
namespace QuanLyTiemGiatLa
{
	...
	public partial class frmMain : Form
	{
		...
		private void frmMain_Load(object sender, EventArgs e)
		{
			...
			this.tsslbPhienBan.Text = "Phiên bản ngày 03/03/2012";
		}
		...
		private void LoadQuyenButton()
		{
			...
			//switch (BienChung.userCurrent.ChucVu)
			//{
			//    case Entity.ChucVu.KeToan:
			//        btnBangGia.Enabled = false;
			//        btnCauHinhGiaDeDo.Enabled = false;
			//        btnDotGiamGia.Enabled = false;
			//        btnKhachHang.Enabled = false;
			//        btnKieuGiat.Enabled = false;
			//        btnLoaiHang.Enabled = false;
			//        btnMatHang.Enabled = false;
			//        btnMucDoVip.Enabled = false;
			//        btnNhanVien.Enabled = false;
			//        btnDanhSachPhieu.Enabled = false;
			//        btnLapPhieu.Enabled = false;
			//        btnNhungViecCanLam.Enabled = false;
			//        btnCauHinhHeThong.Enabled = false;
			//        break;
			//    case Entity.ChucVu.Admin:
			//        break;
			//    default:
			//        btnBangGia.Enabled = false;
			//        btnDotGiamGia.Enabled = false;
		...
		private void btnCauHinhGiaDeDo_Click(object sender, EventArgs e)
		{
		...
		private void btnCapNhat_Click(object sender, EventArgs e)
		{
			try
			{
				var listUser = UserBO.SelectAll();
				for (int i = 0; i < listUser.Count; i++)
				{
					listUser[i].Password = Xuly.Xuly.MaHoaPassword(listUser[i].Password);
					UserBO.ChangePass(listUser[i].UserName, listUser[i].Password);
				}
